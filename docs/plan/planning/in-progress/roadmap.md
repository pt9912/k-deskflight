...
| M3 | Erste Prüfung — Kubernetes-Version | M2 | In Progress (siehe [`slice-M3-kubernetes-version-check.md`](./slice-M3-kubernetes-version-check.md)) |
...
In Progress. M1 und M2 geschlossen am 2026-05-17
