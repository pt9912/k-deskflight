...
| ----- | ---------- | ------ |
| [`roadmap.md`](roadmap.md) | MVP v0.1 (`LH-MVP-002`, `LH-PRI-001`) in sieben Slices M1–M7 | In Progress — M1, M2, M3 geschlossen 2026-05-17; M4 geschlossen 2026-05-18; M5–M7 weiterhin Pending. |
